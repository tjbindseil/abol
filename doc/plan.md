...
* always
    ...
    * show on home screen
* simple mode
    * arm alarm button always uses current location and 200m
* advanced mode
    * select location
        * if inside area, auto alarm when leaving, else, auto alarm when entering
...
## completed
* better title
    - ABOL - Alarming Based On Location
